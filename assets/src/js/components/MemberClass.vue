		...
		<v-card flat>
			<v-container class="pb-0">
				<v-row>
					...
					<v-divider vertical></v-divider>
					<v-col cols="12" sm="4" md="2" align="center" justify="center" class=" nav">
							<v-row justify="center"><v-btn block text  @click="navClick($event)">Group SMS</v-btn></v-row>
					</v-col>
					<v-divider vertical></v-divider>
					<v-col cols="12" sm="4" md="2" align="center" justify="center" class=" nav">
							<v-row justify="center"><v-btn block text class="px-0"  @click="navClick($event)">Take Over</v-btn></v-row>
					</v-col>
					<v-divider vertical></v-divider>
					<v-col cols="12" sm="4" md="2" align="center" justify="center" class=" nav">
...
export default {
	...
	data: vm => ({
		...
		types: ['All Types', 'Phone', 'Video Skype', 'Video Schoolnet'],
		headers: [{
				text: 'Academy',
				align: 'left',
				value: 'academy',
