					 ...
					 Warning
								...
								<v-row class="mt-4">
									...
									<v-col cols="12" sm="6" md="5" class="pb-0">
										...
										<v-text-field class="pb-0" label="Name" v-model="memberLeveltest.name" placeholder="Name" outlined></v-text-field>
									</v-col>
									<v-col cols="12" sm="6" md="5" class="pb-0">
		...
		<v-btn color="success" x-large :disabled = "!memberRegularClass.preference_number" @click="verifyReferenceNumber">Verify</v-btn>
								...
								<v-row>
									<v-col cols="12" sm="6" md="3" class="pb-0">
										...
										<v-text-field class="pb-0" label="Name" v-model="memberRegularClass.name" placeholder="Name" outlined></v-text-field>
									</v-col>
									<v-col cols="12" sm="6" md="3" class="pb-0">
...
export default {
	...
	data: vm => ({
	 ...
	 inputValue5: "",
			 ...
			 types: ['Phone',  'Video Skype', 'Video Schoolnet'],
      ...
      parseDate (date) {
        ...
        return `${year}-${month.padStart(2, '0')}-${day.padStart(2, '0')}`
			...
			onChange(event) {
						 ...
						 }else if(event == "Video Skype" || event == "Video Schoolnet" ){
...
this.$set(this.$data, 'Tutors', res.data.tutors)
				 ...
				 addLevelTest(){
					 ...
					 console.log(this.memberLeveltest)
...
console.log(res.data, 'res')
				 ...
				 checkPrice() {
					 ...
					 if ((this.memberRegularClass.class_type === "Video Skype" || this.memberRegularClass.class_type === "Video Schoolnet") && this.memberRegularClass.days === "2" && this.memberRegularClass.duration === "20 minutes" && this.memberRegularClass.period ===
						 "1 month") {
						 this.krw = "KRW"
						 this.price = "88,000"
					 }
					 ...
					 if ((this.memberRegularClass.class_type === "Video Skype" || this.memberRegularClass.class_type === "Video Schoolnet") && this.memberRegularClass.days === "3" && this.memberRegularClass.duration === "20 minutes" && this.memberRegularClass.period ===
						 "1 month") {
						 this.krw = "KRW"
						 this.price = "118,000"
					 }
					 ...
					 if ((this.memberRegularClass.class_type === "Video Skype" || this.memberRegularClass.class_type === "Video Schoolnet") && this.memberRegularClass.days === "5" && this.memberRegularClass.duration === "20 minutes" && this.memberRegularClass.period ===
						 "1 month") {
						 this.krw = "KRW"
						 this.price = "148,000"
					 }
					 ...
					 if ((this.memberRegularClass.class_type === "Video Skype" || this.memberRegularClass.class_type === "Video Schoolnet") && this.memberRegularClass.days === "2" && this.memberRegularClass.duration === "30 minutes" && this.memberRegularClass.period ===
						 "1 month") {
						 this.krw = "KRW"
						 this.price = "120,000"
					 }
					 ...
					 if ((this.memberRegularClass.class_type === "Video Skype" || this.memberRegularClass.class_type === "Video Schoolnet") && this.memberRegularClass.days === "3" && this.memberRegularClass.duration === "30 minutes" && this.memberRegularClass.period ===
						 "1 month") {
						 this.krw = "KRW"
						 this.price = "162,000"
					 }
					 ...
					 if ((this.memberRegularClass.class_type === "Video Skype" || this.memberRegularClass.class_type === "Video Schoolnet") && this.memberRegularClass.days === "5" && this.memberRegularClass.duration === "30 minutes" && this.memberRegularClass.period ===
						 "1 month") {
						 this.krw = "KRW"
						 this.price = "210,000"
					 }
					 ...
					 if ((this.memberRegularClass.class_type === "Video Skype" || this.memberRegularClass.class_type === "Video Schoolnet") && this.memberRegularClass.days === "2" && this.memberRegularClass.duration === "40 minutes" && this.memberRegularClass.period ===
						 "1 month") {
						 this.krw = "KRW"
						 this.price = "114,000"
					 }
					 ...
					 if ((this.memberRegularClass.class_type === "Video Skype" || this.memberRegularClass.class_type === "Video Schoolnet") && this.memberRegularClass.days === "3" && this.memberRegularClass.duration === "40 minutes" && this.memberRegularClass.period ===
						 "1 month") {
						 this.krw = "KRW"
						 this.price = "192,000"
					 }
					 ...
					 if ((this.memberRegularClass.class_type === "Video Skype" || this.memberRegularClass.class_type === "Video Schoolnet") && this.memberRegularClass.days === "5" && this.memberRegularClass.duration === "40 minutes" && this.memberRegularClass.period ===
						 "1 month") {
						 this.krw = "KRW"
						 this.price = "240,000"
					 }
					 ...
					 if ((this.memberRegularClass.class_type === "Video Skype" || this.memberRegularClass.class_type === "Video Schoolnet") && this.memberRegularClass.days === "2" && this.memberRegularClass.duration === "50 minutes" && this.memberRegularClass.period ===
						 "1 month") {
						 this.krw = "KRW"
						 this.price = "162,000"
					 }
					 ...
					 if ((this.memberRegularClass.class_type === "Video Skype" || this.memberRegularClass.class_type === "Video Schoolnet") && this.memberRegularClass.days === "3" && this.memberRegularClass.duration === "50 minutes" && this.memberRegularClass.period ===
						 "1 month") {
						 this.krw = "KRW"
						 this.price = "218,000"
					 }
					 ...
					 if ((this.memberRegularClass.class_type === "Video Skype" || this.memberRegularClass.class_type === "Video Schoolnet") && this.memberRegularClass.days === "5" && this.memberRegularClass.duration === "50 minutes" && this.memberRegularClass.period ===
						 "1 month") {
						 this.krw = "KRW"
						 this.price = "273,000"
					 }
