			...
			<v-hover v-slot:default="{ hover }">
				<v-card class="pt-2" max-width="500">
					...
					<v-row class="pl-4 pt-2 pb-3">
						...
						<v-col cols="2">
							<v-btn v-if="isEdit" color="success" small>Update</v-btn>
						</v-col>
						<v-col cols="2">
								...
								<tbody>
									...
									<tr>
										...
										<td class="account_table" v-if="!isSetPhone">
											<v-text-field class="mt-2" placeholder="Phone Number" regular></v-text-field>
										</td>
									</tr>
									<tr>
										<td class="account_table font-weight-bold">Email Adress</td>
										<td class="account_table" v-if="isSetEmail">test@yahoo.com</td>
										<td class="account_table" v-if="!isSetEmail">
											<v-text-field class="mt-2" placeholder="Email" regular></v-text-field>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="account_table" v-if="isSetRecordings">Yes</td>
									...
									<tr>
										...
										<td class="account_table" v-if="isSetTakeOver">No</td>
